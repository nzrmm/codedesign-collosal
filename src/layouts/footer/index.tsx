...
const Footer = () => {
  ...
  return (
    <div className={cx('px-52 mb-16 relative')}>
      ...
      <div
        className={cx(
          'flex items-center justify-between border-y border-white/10 py-12 mb-28',
        )}
      >
      ...
      <div className={cx('flex')}>
        <div className={cx('w-3/12')}>
          ...
          <div>
            <Typography variant='textBase'>Copyright © 2021</Typography>
            <Typography variant='textBase'>Design By Collosal LLC</Typography>
          </div>
        </div>
        ...
        <div className={cx('w-3/12')}>
          <Typography
            variant='textSm'
            customClassName='!font-medium !text-white tracking-widest mb-5'
          >
            SERVICES
          </Typography>
            ...
            {footer.services.map((item, index) => {
              return (
                <Link key={index} href={item.href}>
                  <Typography variant='textBase'>{item.label}</Typography>
                </Link>
              );
            })}
          </div>
