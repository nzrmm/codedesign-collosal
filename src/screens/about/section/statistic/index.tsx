...
const Statistic = () => {
  return (
    <div className={cx('px-52 mb-32')}>
      ...
      <div className={cx('grid grid-cols-3 divide-x divide-white/5 bg-white/10 p-11 rounded-md mb-14')}>
        {statistics.map((statistic, index) => {
          return (
            <div key={index} className={cx('flex items-center justify-center gap-10')}>
              <div className={cx('flex justify-center items-center w-[70px] h-[70px] bg-white/5 rounded-md')}>
                <Image
                  width={30}
                  height={30}
                  src={statistic.icon}
              ...
              <div>
                ...
                <Typography variant='textBase' customClassName='!font-bold -mt-2'>
                  {statistic.type}
                </Typography>
              </div>
            </div>
